...
let filtered = myRandom().filter(num => num % 2 === 0)
...
function somma1 (){
 ...
 // let sum1 = array.reduce((sum4, element) =>  sum4 + element , 10)
return array.reduce(function(sum4 , element){
    return sum4 + element
}, 10)
}
console.log(somma1(array))
...
*/
  const titleArray = movies.map((element) => {
